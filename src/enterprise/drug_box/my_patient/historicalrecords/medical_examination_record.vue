...
<script>
  ...
  import brdge from '../../../statedata/bridge';
  export default {
    data() {
      return {
...
<style lang="less">
  ...
  .table_box{width: 100%; height: auto;padding: 20px ;background: #f7f7f7;border-right: 1px solid #d4d4d4;border-bottom: 1px solid #d4d4d4;border-left: 1px solid #d4d4d4;border-radius:  0 0 4px 4px;
  }
